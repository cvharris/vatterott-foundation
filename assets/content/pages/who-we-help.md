---
title: 'Who We Help'
subtitle: For nearly 70 years, the Vatterott Foundation has partnered with non-profit organizations to serve those in need. The Foundation would like to thank each organization for their commitment to social justice and service to the poor. Below are some of the organizations that have received funding from the Vatterott Foundation in the recent past.
orgs:
  ...
  - name: 'Gateway Greening'
    link: ''
  - name: 'Gateway Vincentian Voluntees'
    link: ''
  ...
  - name: 'Incarnate Word Foundation'
    link: ''
  - name: 'Intercommunity Housing Associaion'
    link: ''
  ...
  - name: 'Notre Dame Preschool'
    link: ''
  - name: 'Off the Cuff  Piwacket Theatre or Children'
    link: ''
  ...
  - name: 'Piasa Area Habitat for Humanity'
    link: ''
  - name: 'Pregnancy Resource Center  Greater St. Lous'
    link: ''
  ...
  - name: 'Saint Katharine Drexel'
    link: ''
  - name: 'Saint Mary Magdelen Catholic Church'
    link: ''
  ...
  - name: 'SLACO (Etzel Make A Difference Center)'
    link: ''
  - name: 'Small Word Adoption Foundation'
    link: ''
  ...
  - name: 'St. Dominic H.S.   Scholarship (4 yr. Pledge)'
    link: ''
  ...
  - name: 'St. Louis HELP'
    link: ''
  - name: 'St. Louis LaSalle Leadersip Inc.'
    link: ''
